...
#tandem repeat
tandem_rep_fa=pcutils::read_fasta("../analysis/seq_feature/bac_tandem_repeat_f.fa")
#consensus repeat
...
```{r}
seq_stat=lapply(list(level4_fa,random_fa,tandem_rep_fa,consensus_rep_fa), \(i)summary_seq(i)[,c(-1,-2)])
...
RColorBrewer::brewer.pal(4,"Set1")->cols
pcutils::add_theme()
